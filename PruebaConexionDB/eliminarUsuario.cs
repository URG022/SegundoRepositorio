...
namespace PruebaConexionDB
{
    public partial class eliminarUsuario : Form
    {
       ...
       // SqlConnection conexion = new SqlConnection("Data Source=DESKTOP-O4T7IKM\\SQLEXPRESS; Initial Catalog=ProyectoClinica; Integrated Security=True");
        ...
        public void eliminarUsuario_Load(object sender, EventArgs e)
        {
